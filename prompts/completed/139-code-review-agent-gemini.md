...
completed: "2026-05-24T11:27:57Z"
---
...
<objective>
Run a full code review of agent/gemini and generate a fix prompt for each Critical or Important finding.
</objective>
...
Service directory: `agent/gemini/`
</context>
...
Run `/coding:code-review full agent/gemini` to get a comprehensive review with all specialist agents.
...
**Filename:** `review-agent-gemini-<fix-description>.md`
...
<!-- Example: - agent/gemini/pkg/session/runner.go (~line 142, function Run) -->
</context>
...
ls prompts/review-agent-gemini-*.md 2>/dev/null || echo "No findings — clean review"
</verification>
