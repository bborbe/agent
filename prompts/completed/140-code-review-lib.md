...
completed: "2026-05-24T11:35:10Z"
---
...
<!-- Example: - lib/pkg/session/runner.go (~line 142, function Run) -->
</context>
...
ls prompts/review-lib-*.md 2>/dev/null || echo "No findings — clean review"
</verification>
