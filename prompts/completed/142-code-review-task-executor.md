...
completed: "2026-05-24T11:49:58Z"
---
...
<objective>
Run a full code review of task/executor and generate a fix prompt for each Critical or Important finding.
</objective>
...
Service directory: `task/executor/`
</context>
...
Run `/coding:code-review full task/executor` to get a comprehensive review with all specialist agents.
...
**Filename:** `review-task-executor-<fix-description>.md`
...
<!-- Example: - task/executor/pkg/session/runner.go (~line 142, function Run) -->
</context>
...
ls prompts/review-task-executor-*.md 2>/dev/null || echo "No findings — clean review"
</verification>
