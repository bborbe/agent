...
func (fake *TaskCreateCommandSender) SendCommand(arg1 context.Context, arg2 task.CreateCommand) error {
...
func (fake *TaskCreateCommandSender) SendCommandCallCount() int {
	fake.sendCommandMutex.RLock()
	defer fake.sendCommandMutex.RUnlock()
	return len(fake.sendCommandArgsForCall)
}

func (fake *TaskCreateCommandSender) SendCommandCalls(stub func(context.Context, task.CreateCommand) error) {
	fake.sendCommandMutex.Lock()
	defer fake.sendCommandMutex.Unlock()
	fake.SendCommandStub = stub
}

func (fake *TaskCreateCommandSender) SendCommandArgsForCall(i int) (context.Context, task.CreateCommand) {
	fake.sendCommandMutex.RLock()
	defer fake.sendCommandMutex.RUnlock()
...
func (fake *TaskCreateCommandSender) SendCommandReturns(result1 error) {
	fake.sendCommandMutex.Lock()
	defer fake.sendCommandMutex.Unlock()
...
func (fake *TaskCreateCommandSender) SendCommandReturnsOnCall(i int, result1 error) {
	fake.sendCommandMutex.Lock()
	defer fake.sendCommandMutex.Unlock()
	fake.SendCommandStub = nil
...
func (fake *TaskCreateCommandSender) Invocations() map[string][][]interface{} {
...
func (fake *TaskCreateCommandSender) recordInvocation(key string, args []interface{}) {
...
var _ task.CreateCommandSender = new(TaskCreateCommandSender)
